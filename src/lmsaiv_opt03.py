...
class Opt03:
    ...
    #     print()
    #
    #     print('2. Derive detector rotation and offset differences from trace data. ')
    #     # ---------- ISO-ALPHA -------------------
    ...
    #
    #     mosaics = Filer.read_mosaic_list([test_name, 'iso_lambda', 'sig_bs'])
    #
    #
    #     bgd_mosaics = Filer.read_mosaic_list([test_name, 'iso_lambda', 'bgd'])
    #     bgd_mosaic = OptTools.transform_detector_image(bgd_mosaics[0],
    #                                                    det_no=test_det_no,
    #                                                    xy_pix=test_det_offset,
    #                                                    angle=test_img_rot_deg)
