...
class Engine:
    ...
    def run():
        ...
        # ============ Set configurations ============================================================
        # lms_dark = {'id': 'lms-opt-01-t1-dark', 'opticon': nominal, 'wave_cen': 4700, 'dit': 1.5, 'ndit': 200,
        #                 'bgd_src': 'wcu_bb', 'fp_mask': 'open', 'lms_pp1': 'closed'}
        # lms_opt_01_t1_nom_flood = {'id': 'lms-opt-01-t1-flood_ext', 'opticon': nominal, 'wave_cen': 4700,
        #                            'bgd_src': 'wcu_bb', 'fp_mask': 'open', 'lms_pp1': 'open'}
        # lms_opt_01_t1_ext_flood = lms_opt_01_t1_nom_flood.copy()
        # lms_opt_01_t1_ext_flood['opticon'] = 'spifu'
        # lms_opt_01_t1_flood_ext = {'id': 'lms-opt-01-t1-flood_ext', 'opticon': spifu, 'wave_cen': 4700,
        #                            'bgd_src': 'wcu_bb', 'fp_mask': 'open', 'lms_pp1': 'open'}
        # lms_opt_01_t5_step1nom = {'id': 'lms-opt-01-t5-step1nom', 'opticon': nominal, 'wave_cen': 4700,
        #                           'bgd_src': 'sky', 'fp_mask': 'open', 'lms_pp1': 'closed'}
        #
        # lms_opt_01_t1_config = {'lms_opt_01_t1_nom_dark1': lms_dark,
        #                         'lms_opt_01_t1_nom_dark2': lms_dark,
        #                         'lms_opt_01_t1_nom_flood': lms_opt_01_t1_nom_flood,
        #                         'lms_opt_01_t1_ext_dark1': lms_dark,
        #                         'lms_opt_01_t1_ext_dark2': lms_dark,
        #                         'lms_opt_01_t1_ext_flood': lms_opt_01_t1_ext_flood}

        # sim_config = lms_opt_01_t1_config
        obs_map = ObsMap()
        sim_config = obs_map.get_configuration('lms_opt_01_t2')
        ...
        for obs_name in sim_config:
            ...
            opticon = nominal if obs_cfg['opticon'] == 'nominal' else spifu
